        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "hch12ctl",
                    description: Some(
                        "host channel-12 characteristics register (HCH12CTL)",
                    ),
                    array: None,
                    byte_offset: 0x280,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch12stctl",
                    description: Some(
                        "host channel-12 split transaction control register (HCH12STCTL)",
                    ),
                    array: None,
                    byte_offset: 0x284,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch12intf",
                    description: Some(
                        "host channel-12 interrupt register (HCH12INTF)",
                    ),
                    array: None,
                    byte_offset: 0x288,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch12inten",
                    description: Some(
                        "host channel-12 interrupt enable register (HCH12INTEN)",
                    ),
                    array: None,
                    byte_offset: 0x28c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch12len",
                    description: Some(
                        "host channel-12 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x290,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch13ctl",
                    description: Some(
                        "host channel-13 characteristics register (HCH13CTL)",
                    ),
                    array: None,
                    byte_offset: 0x2a0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch13stctl",
                    description: Some(
                        "host channel-13 split transaction control register (HCH13STCTL)",
                    ),
                    array: None,
                    byte_offset: 0x2a4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch13intf",
                    description: Some(
                        "host channel-13 interrupt register (HCH13INTF)",
                    ),
                    array: None,
                    byte_offset: 0x2a8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch13inten",
                    description: Some(
                        "host channel-13 interrupt enable register (HCH13INTEN)",
                    ),
                    array: None,
                    byte_offset: 0x2ac,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch13len",
                    description: Some(
                        "host channel-13 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x2b0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch14ctl",
                    description: Some(
                        "host channel-14 characteristics register (HCH14CTL)",
                    ),
                    array: None,
                    byte_offset: 0x2c0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch14stctl",
                    description: Some(
                        "host channel-14 split transaction control register (HCH14STCTL)",
                    ),
                    array: None,
                    byte_offset: 0x2c4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch14intf",
                    description: Some(
                        "host channel-14 interrupt register (HCH14INTF)",
                    ),
                    array: None,
                    byte_offset: 0x2c8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch14inten",
                    description: Some(
                        "host channel-14 interrupt enable register (HCH14INTEN)",
                    ),
                    array: None,
                    byte_offset: 0x2cc,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch14len",
                    description: Some(
                        "host channel-14 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x2d0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch15ctl",
                    description: Some(
                        "host channel-15 characteristics register (HCH15CTL)",
                    ),
                    array: None,
                    byte_offset: 0x2e0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch15stctl",
                    description: Some(
                        "host channel-15 split transaction control register (HCH15STCTL)",
                    ),
                    array: None,
                    byte_offset: 0x2e4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch15intf",
                    description: Some(
                        "host channel-15 interrupt register (HCH15INTF)",
                    ),
                    array: None,
                    byte_offset: 0x2e8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch15inten",
                    description: Some(
                        "host channel-15 interrupt enable register (HCH15INTEN)",
                    ),
                    array: None,
                    byte_offset: 0x2ec,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hch15len",
                    description: Some(
                        "host channel-15 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x2f0,
                    inner: BlockItemInner::Register(
