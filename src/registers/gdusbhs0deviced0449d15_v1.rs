        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "diep6ctl",
                    description: Some(
                        "device endpoint-6 control register",
                    ),
                    array: None,
                    byte_offset: 0x1c0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep6intf",
                    description: Some(
                        "device endpoint-6 interrupt register",
                    ),
                    array: None,
                    byte_offset: 0x1c8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep6len",
                    description: Some(
                        "device IN endpoint-6 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x1d0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep6tfstat",
                    description: Some(
                        "device IN endpoint 6 transmit FIFO status register",
                    ),
                    array: None,
                    byte_offset: 0x1d8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep7ctl",
                    description: Some(
                        "device endpoint-7 control register",
                    ),
                    array: None,
                    byte_offset: 0x1e0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep7intf",
                    description: Some(
                        "device endpoint-7 interrupt register",
                    ),
                    array: None,
                    byte_offset: 0x1e8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep7len",
                    description: Some(
                        "device IN endpoint-7 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x1f0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "diep7tfstat",
                    description: Some(
                        "device IN endpoint 7 transmit FIFO status register",
                    ),
                    array: None,
                    byte_offset: 0x1f8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "doep6intf",
                    description: Some(
                        "device out endpoint-6 interrupt flag register",
                    ),
                    array: None,
                    byte_offset: 0x3c8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "doep6len",
                    description: Some(
                        "device OUT endpoint-6 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x3d0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "doep7intf",
                    description: Some(
                        "device out endpoint-7 interrupt flag register",
                    ),
                    array: None,
                    byte_offset: 0x3e8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "doep7len",
                    description: Some(
                        "device OUT endpoint-7 transfer length register",
                    ),
                    array: None,
                    byte_offset: 0x3f0,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "naken",
                    description: Some(
                        "Interrupt enable bit of NAK handshake sent by USBHS",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "stpfen",
                    description: Some(
                        "SETUP phase finished interrupt enable bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
                ...
                Field {
                    name: "eprxfovren",
                    description: Some(
                        "Endpoint Rx FIFO over run interrupt enable bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "btbstpen",
                    description: Some(
                        "Back-to-back SETUP packets interrupt enable bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
                ...
                Field {
                    name: "nyeten",
                    description: Some(
                        "Send NYET handshake interrupt enable bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
