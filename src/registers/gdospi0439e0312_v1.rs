        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "wptcfg",
                    description: Some(
                        "Wrap transfer configuration register",
                    ),
                    array: None,
                    byte_offset: 0x140,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "wtcfg",
                    description: Some(
                        "Write transfer configuration register",
                    ),
                    array: None,
                    byte_offset: 0x180,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hblcfg",
                    description: Some(
                        "HyperBus lantency configuration register",
                    ),
                    array: None,
                    byte_offset: 0x200,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "psc",
                    description: Some(
                        "This field defines the scaler factor for generating SCK based on the kernel clock (value+1)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
