        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "mch3cv",
                    description: Some(
                        "Capture/compare value of multi mode channel 3",
                    ),
                    array: None,
                    byte_offset: 0x60,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "fcchp1",
                    description: Some(
                        "Free complementary channel protection register 1",
                    ),
                    array: None,
                    byte_offset: 0x80,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "fcchp2",
                    description: Some(
                        "Free complementary channel protection register 2",
                    ),
                    array: None,
                    byte_offset: 0x84,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "fcchp3",
                    description: Some(
                        "Free complementary channel protection register 3",
                    ),
                    array: None,
                    byte_offset: 0x88,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "brk0in1en",
                    description: Some(
                        "BREAK0 BRKIN1 alternate function input enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "brk0in2en",
                    description: Some(
                        "BREAK0 BRKIN2 alternate function input enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    name: "brk0in1p",
                    description: Some(
                        "BREAK0 BRKIN1 alternate function input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
                ...
                Field {
                    name: "brk0in2p",
                    description: Some(
                        "BREAK0 BRKIN2 alternate function input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 18,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "brk1in0en",
                    description: Some(
                        "BRK1 BRK1IN alternate function input enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "brk1in1en",
                    description: Some(
                        "BREAK1 BRKIN1 alternate function input enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "brk1in0p",
                    description: Some(
                        "BRK1 BRKIN0 alternate function input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "brk1in1p",
                    description: Some(
                        "BREAK1 BRKIN1 alternate function input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
                ...
                Field {
                    name: "brk1in2p",
                    description: Some(
                        "BREAK1 BRKIN2 alternate function input polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 18,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mch2p",
                    description: Some(
                        "Multi mode channel 2 capture/compare polarity",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 11,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fcchp1en",
                    description: Some(
                        "Free complementary channel protection register 1 enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fcchp2en",
                    description: Some(
                        "Free complementary channel protection register 2 enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fcchp3en",
                    description: Some(
                        "Free complementary channel protection register 3 enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "smc1",
                    description: Some(
                        "Part of SMC is used to enable external clock mode 1",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
