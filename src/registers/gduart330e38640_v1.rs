        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "fcs",
                    description: Some(
                        "USART FIFO control and status register",
                    ),
                    array: None,
                    byte_offset: 0xd0,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "addr0",
                    description: Some(
                        "Address 0 of the USART terminal",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "addr1",
                    description: Some(
                        "Address 1 of the USART terminal",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rfcnt_3_4",
                    description: Some(
                        "Bits 3_4 of receive FIFO counter number",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "tfec",
                    description: Some(
                        "Transmit FIFO empty flag clear",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
