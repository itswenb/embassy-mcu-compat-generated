        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ccnt",
                    description: Some(
                        "ADC charge pulse width counter",
                    ),
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eteic",
                    description: Some(
                        "External trigger enable for inserted channels",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "tsven",
                    description: Some(
                        "Channel 16 (temperature sensor) enable of ADC.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
                ...
                Field {
                    name: "inrefen",
                    description: Some(
                        "Channel 17 (internal reference voltage) enable of ADC.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
                ...
                Field {
                    name: "vbaten",
                    description: Some(
                        "Channel 18 (1/3 voltage of external battery) enable of ADC",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 25,
                ...
                Field {
                    name: "vlcden",
                    description: Some(
                        "Channel 19 (1/3 voltage of VLCD) enable of ADC",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "difctl0_14",
                    description: Some(
                        "Differential mode for channel 14..0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "difctl15_19",
                    description: Some(
                        "Differential mode for channel 19..15",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "spt19",
                    description: Some(
                        "Channel 19 sample time selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 27,
