        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "intc",
                    description: Some(
                        "DCI Interrupt flag clear register",
                    ),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "fsm",
                    description: Some(
                        "Frame start code mask bits in embedded synchronous mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "lsm",
                    description: Some(
                        "Line start code mask bits in embedded synchronous mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "lem",
                    description: Some(
                        "Line end code mask bits in embedded synchronous mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "fem",
                    description: Some(
                        "Frame end code mask bits in embedded synchronous mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
