...
mod _vectors {
    ...
    pub static __INTERRUPTS: [Vector; 69] = [
        ...
        Vector { _handler: LPUART_WKUP },
        Vector { _handler: LPTIMER },
    ];
}
pub const TIM2: gdtimer15f311eaa::Timer1 = unsafe { gdtimer15f311eaa::Timer1::from_ptr(0x4000_0000usize as _) };
...
pub const TIM12: gdtimer83f762be9::Timer8 = unsafe { gdtimer83f762be9::Timer8::from_ptr(0x4000_1800usize as _) };
pub const SLCD: gdslcd8086d68f::Slcd = unsafe { gdslcd8086d68f::Slcd::from_ptr(0x4000_2400usize as _) };
...
pub const UART5: gduart4f478961c::Uart4 = unsafe { gduart4f478961c::Uart4::from_ptr(0x4000_5000usize as _) };
...
pub const LPUART: gdlpuart3ad1937d::Lpuart = unsafe { gdlpuart3ad1937d::Lpuart::from_ptr(0x4000_8000usize as _) };
pub const LPTIMER: gdlptimer81986a0b::Lptimer = unsafe { gdlptimer81986a0b::Lptimer::from_ptr(0x4000_9400usize as _) };
...
pub const VREF: gdvref8ca405d5::Vref = unsafe { gdvref8ca405d5::Vref::from_ptr(0x4001_0030usize as _) };
pub const EXTI: gdexti30fc9668::Exti = unsafe { gdexti30fc9668::Exti::from_ptr(0x4001_0400usize as _) };
pub const ADC1: gdadc34b106d5::Adc = unsafe { gdadc34b106d5::Adc::from_ptr(0x4001_2400usize as _) };
...
pub const TIM9: gdtimer83f762be9::Timer8 = unsafe { gdtimer83f762be9::Timer8::from_ptr(0x4001_4c00usize as _) };
pub const DBGMCU: gddbgmcu738c6f06::Dbgmcu = unsafe { gddbgmcu738c6f06::Dbgmcu::from_ptr(0x4001_5800usize as _) };
...
pub mod bdma;
#[path = "../../peripherals/dmamux_gdbba0ac7e1f00.rs"]
pub mod dmamux;
#[path = "../../peripherals/flash_g0x0.rs"]
pub mod flash;
#[path = "../../peripherals/gdadc34b106d5_v1.rs"]
...
#[path = "../../peripherals/gddbgmcu738c6f06_v1.rs"]
...
#[path = "../../peripherals/gdlptimer81986a0b_v1.rs"]
pub mod gdlptimer81986a0b;
#[path = "../../peripherals/gdlpuart3ad1937d_v1.rs"]
pub mod gdlpuart3ad1937d;
#[path = "../../peripherals/gdrtc30fffb52_v1.rs"]
pub mod gdrtc30fffb52;
#[path = "../../peripherals/gdslcd8086d68f_v1.rs"]
...
#[path = "../../peripherals/gdtimer15f311eaa_v1.rs"]
pub mod gdtimer15f311eaa;
#[path = "../../peripherals/gdtimer83f762be9_v1.rs"]
...
#[path = "../../peripherals/gduart4f478961c_v1.rs"]
...
#[path = "../../peripherals/gdvref8ca405d5_v1.rs"]
