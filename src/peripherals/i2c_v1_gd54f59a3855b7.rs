...
# [inline (always)]
pub const fn trise (self) -> crate :: common :: Reg < regs :: Trise , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "SAM control and status register"]
# [inline (always)]
...
# [inline (always)]
pub const fn fmpcfg (self) -> crate :: common :: Reg < regs :: Fmpcfg , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x90usize) as _) } } } pub mod regs { # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ dr: {=u8:?} }}" , self . dr ()) } } # [doc = "FLTR register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fltr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fltr {{ dnf: {:?}, anoff: {=bool:?} }}" , self . dnf () , self . anoff ()) } } # [doc = "Fast mode plus configure register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fmpcfg { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fmpcfg {{ fmpen: {=bool:?} }}" , self . fmpen ()) } } # [doc = "Own address register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
