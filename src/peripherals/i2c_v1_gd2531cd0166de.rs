...
# [inline (always)]
pub const fn trise (self) -> crate :: common :: Reg < regs :: Trise , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "Filter control register"]
# [inline (always)]
...
# [inline (always)]
pub const fn samcs (self) -> crate :: common :: Reg < regs :: Samcs , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x80usize) as _) } } } pub mod regs { # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr { Ccr (0) } } impl core :: fmt :: Debug for Ccr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr") . field ("ccr" , & self . ccr ()) . field ("duty" , & self . duty ()) . field ("f_s" , & self . f_s ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Ccr {{ ccr: {=u16:?}, duty: {:?}, f_s: {:?} }}" , self . ccr () , self . duty () , self . f_s ()) } } # [doc = "Control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr1 { Cr1 (0) } } impl core :: fmt :: Debug for Cr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr1") . field ("pe" , & self . pe ()) . field ("smbus" , & self . smbus ()) . field ("smbtype" , & self . smbtype ()) . field ("enarp" , & self . enarp ()) . field ("enpec" , & self . enpec ()) . field ("engc" , & self . engc ()) . field ("nostretch" , & self . nostretch ()) . field ("start" , & self . start ()) . field ("stop" , & self . stop ()) . field ("ack" , & self . ack ()) . field ("pos" , & self . pos ()) . field ("pec" , & self . pec ()) . field ("alert" , & self . alert ()) . field ("swrst" , & self . swrst ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr1 {{ pe: {=bool:?}, smbus: {:?}, smbtype: {:?}, enarp: {=bool:?}, enpec: {=bool:?}, engc: {=bool:?}, nostretch: {=bool:?}, start: {=bool:?}, stop: {=bool:?}, ack: {=bool:?}, pos: {:?}, pec: {=bool:?}, alert: {=bool:?}, swrst: {=bool:?} }}" , self . pe () , self . smbus () , self . smbtype () , self . enarp () , self . enpec () , self . engc () , self . nostretch () , self . start () , self . stop () , self . ack () , self . pos () , self . pec () , self . alert () , self . swrst ()) } } # [doc = "Control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2 { Cr2 (0) } } impl core :: fmt :: Debug for Cr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2") . field ("freq" , & self . freq ()) . field ("iterren" , & self . iterren ()) . field ("itevten" , & self . itevten ()) . field ("itbufen" , & self . itbufen ()) . field ("dmaen" , & self . dmaen ()) . field ("last" , & self . last ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Cr2 {{ freq: {=u8:?}, iterren: {=bool:?}, itevten: {=bool:?}, itbufen: {=bool:?}, dmaen: {=bool:?}, last: {=bool:?} }}" , self . freq () , self . iterren () , self . itevten () , self . itbufen () , self . dmaen () , self . last ()) } } # [doc = "Data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Dr {{ dr: {=u8:?} }}" , self . dr ()) } } # [doc = "Filter control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fctl { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fctl {{ df: {=u8:?}, afd: {=bool:?} }}" , self . df () , self . afd ()) } } # [doc = "FLTR register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fltr { Fltr (0) } } impl core :: fmt :: Debug for Fltr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fltr") . field ("dnf" , & self . dnf ()) . field ("anoff" , & self . anoff ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fltr { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Fltr {{ dnf: {:?}, anoff: {=bool:?} }}" , self . dnf () , self . anoff ()) } } # [doc = "Own address register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Oar1 { Oar1 (0) } } impl core :: fmt :: Debug for Oar1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Oar1") . field ("add" , & self . add ()) . field ("addmode" , & self . addmode ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Oar1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Oar1 {{ add: {=u16:?}, addmode: {:?} }}" , self . add () , self . addmode ()) } } # [doc = "Own address register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Oar2 { Oar2 (0) } } impl core :: fmt :: Debug for Oar2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Oar2") . field ("endual" , & self . endual ()) . field ("add2" , & self . add2 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Oar2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Oar2 {{ endual: {:?}, add2: {=u8:?} }}" , self . endual () , self . add2 ()) } } # [doc = "SAM control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr1 { Sr1 (0) } } impl core :: fmt :: Debug for Sr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr1") . field ("start" , & self . start ()) . field ("addr" , & self . addr ()) . field ("btf" , & self . btf ()) . field ("add10" , & self . add10 ()) . field ("stopf" , & self . stopf ()) . field ("rxne" , & self . rxne ()) . field ("txe" , & self . txe ()) . field ("berr" , & self . berr ()) . field ("arlo" , & self . arlo ()) . field ("af" , & self . af ()) . field ("ovr" , & self . ovr ()) . field ("pecerr" , & self . pecerr ()) . field ("timeout" , & self . timeout ()) . field ("alert" , & self . alert ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr1 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr1 {{ start: {=bool:?}, addr: {=bool:?}, btf: {=bool:?}, add10: {=bool:?}, stopf: {=bool:?}, rxne: {=bool:?}, txe: {=bool:?}, berr: {=bool:?}, arlo: {=bool:?}, af: {=bool:?}, ovr: {=bool:?}, pecerr: {=bool:?}, timeout: {=bool:?}, alert: {=bool:?} }}" , self . start () , self . addr () , self . btf () , self . add10 () , self . stopf () , self . rxne () , self . txe () , self . berr () , self . arlo () , self . af () , self . ovr () , self . pecerr () , self . timeout () , self . alert ()) } } # [doc = "Status register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr2 { Sr2 (0) } } impl core :: fmt :: Debug for Sr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr2") . field ("msl" , & self . msl ()) . field ("busy" , & self . busy ()) . field ("tra" , & self . tra ()) . field ("gencall" , & self . gencall ()) . field ("smbdefault" , & self . smbdefault ()) . field ("smbhost" , & self . smbhost ()) . field ("dualf" , & self . dualf ()) . field ("pec" , & self . pec ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Sr2 {{ msl: {=bool:?}, busy: {=bool:?}, tra: {=bool:?}, gencall: {=bool:?}, smbdefault: {=bool:?}, smbhost: {=bool:?}, dualf: {=bool:?}, pec: {=u8:?} }}" , self . msl () , self . busy () , self . tra () , self . gencall () , self . smbdefault () , self . smbhost () , self . dualf () , self . pec ()) } } # [doc = "TRISE register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Trise { Trise (0) } } impl core :: fmt :: Debug for Trise { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Trise") . field ("trise" , & self . trise ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Trise { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Trise {{ trise: {=u8:?} }}" , self . trise ()) } } } pub mod vals { # [repr (u8)]
...
NO_FILTER = 0x0 , # [doc = "Digital filter enabled and filtering capability up to 1 tI2CCLK"]
