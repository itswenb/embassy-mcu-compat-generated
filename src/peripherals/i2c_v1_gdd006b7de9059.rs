...
# [inline (always)]
pub const fn trise (self) -> crate :: common :: Reg < regs :: Trise , crate :: common :: RW > { unsafe { crate :: common :: Reg :: from_ptr (self . ptr . add (0x20usize) as _) } } # [doc = "Fast-mode-plus configure register"]
# [inline (always)]
...
# [inline (always)]
pub const fn freq (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x7f ; val as u8 } # [doc = "Peripheral clock frequency"]
# [inline (always)]
pub fn set_freq (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x7f << 0usize)) | (((val as u32) & 0x7f) << 0usize) ; } # [doc = "Error interrupt enable"]
# [inline (always)]
...
impl defmt :: Format for Oar2 { fn format (& self , f : defmt :: Formatter) { defmt :: write ! (f , "Oar2 {{ endual: {:?}, add2: {=u8:?} }}" , self . endual () , self . add2 ()) } } # [doc = "Status register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
# [inline (always)]
pub const fn trise (& self) -> u8 { let val = (self . 0 >> 0usize) & 0x7f ; val as u8 } # [doc = "Maximum rise time in Fast/Standard mode (Master mode)"]
# [inline (always)]
pub fn set_trise (& mut self , val : u8) { self . 0 = (self . 0 & ! (0x7f << 0usize)) | (((val as u32) & 0x7f) << 0usize) ; } } impl Default for Trise { # [inline (always)]
