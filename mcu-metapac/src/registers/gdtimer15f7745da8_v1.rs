        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ch0val_16_19",
                    description: Some(
                        "Capture / compare value of channel0(bit 16 to 19)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ch0ms_2",
                    description: Some(
                        "bit 2 of Channel 0 I/O mode selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ch0ms_2",
                    description: Some(
                        "bit2 of Channel 0 I/O mode selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mch0ms_2",
                    description: Some(
                        "Multi mode channel 0 I/O mode selection(bit2)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
