        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "can0sel",
                    description: Some(
                        "CK_CAN0 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
                ...
                Field {
                    name: "can1sel",
                    description: Some(
                        "CK_CAN1 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lckmie",
                    description: Some(
                        "LXTAL clock monitor interrupt enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lvdrstf",
                    description: Some(
                        "Low Voltage Detect Error reset flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 19,
