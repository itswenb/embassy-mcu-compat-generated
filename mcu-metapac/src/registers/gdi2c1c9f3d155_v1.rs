        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "stpsend",
                    description: Some(
                        "Stop condition sent out in master mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "stloie",
                    description: Some(
                        "Interrupt enable for start lost",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "stpsendie",
                    description: Some(
                        "Interrupt enable for stop condition sent",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
