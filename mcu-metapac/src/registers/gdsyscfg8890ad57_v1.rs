    ...
    fieldsets: &[
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "syscfg_cfg0_pa11_pa12_rmp",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "syscfg_cfg0_usart0_rx_dma_rmp",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
                ...
                Field {
                    name: "syscfg_cfg0_timer15_dma_rmp",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 11,
                ...
                Field {
                    name: "syscfg_cfg0_timer16_dma_rmp",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "syscfg_cfg2_sram_parity_error_lock",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        FieldSet {
            name: "SyscfgCpuIrqLat",
            extends: None,
            description: None,
            bit_size: 32,
            fields: &[
                Field {
                    name: "syscfg_cpu_irq_lat_irq_latency",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
