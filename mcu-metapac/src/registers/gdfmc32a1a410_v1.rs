        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "obctl2",
                    description: Some(
                        "Option byte control register 2",
                    ),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rlbe",
                    description: Some(
                        "Enable read lock block for OTP2.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    name: "pwdn",
                    description: Some(
                        "Flash enter to Deep Power Down mode when no operation.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
                ...
                Field {
                    name: "nwlde",
                    description: Some(
                        "Enable no waiting time area load when system reset. No waiting time area load include load option bytes, OTP, main flash code area.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "obkey",
                    description: Some(
                        "Option bytes operation unlock register.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "spcl",
                    description: Some(
                        "Security protection is level low now.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "spch",
                    description: Some(
                        "Security protection is level high now.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "nbtsb",
                    description: Some(
                        "Not boot from SRAM or bootloader.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "btfosel",
                    description: Some(
                        "Select Boot from flash or OTP1. This bit actives when NBTSB is 1 or BOOT0 is 0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
