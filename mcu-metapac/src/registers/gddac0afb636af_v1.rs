        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dtsel0_3",
                    description: Some(
                        "DAC_OUT0 trigger selection bit[3], refer to DTSEL0[2:0]",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
                ...
                Field {
                    name: "ddisc0",
                    description: Some(
                        "DACx_OUT0 connect GPIO selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "dtsel1_3",
                    description: Some(
                        "DAC_OUT1 trigger selection bit[3], refer to DTSEL1[2:0]",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
                ...
                Field {
                    name: "ddisc1",
                    description: Some(
                        "DACx_OUT1 connect GPIO selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "fifonum0",
                    description: Some(
                        "Number of data in the DAC_OUT0 FIFO",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "fifonum1",
                    description: Some(
                        "Number of data in the DAC_OUT1 FIFO",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
