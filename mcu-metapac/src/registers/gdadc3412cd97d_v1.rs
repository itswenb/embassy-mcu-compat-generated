        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "wdht0",
                    description: Some(
                        "Watchdog high threshold register 0",
                    ),
                    array: None,
                    byte_offset: 0x1c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "wdlt0",
                    description: Some(
                        "Watchdog low threshold register 0",
                    ),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "waien",
                    description: Some(
                        "Weighted averaging in inserted sequence mean value mode enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
                ...
                Field {
                    name: "etmrc",
                    description: Some(
                        "External trigger mode for routine channel",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
                ...
                Field {
                    name: "swrcst",
                    description: Some(
                        "Software start on routine channel",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "adc3_wde0",
                    description: Some(
                        "This bit is the mirror image of the WDE0 bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
                ...
                Field {
                    name: "adc3_wde1",
                    description: Some(
                        "This bit is the mirror image of the WDE1 bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 25,
                ...
                Field {
                    name: "adc3_wde2",
                    description: Some(
                        "This bit is the mirror image of the WDE2 bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
                ...
                Field {
                    name: "adc3_eoc",
                    description: Some(
                        "This bit is the mirror image of the EOC bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 27,
                ...
                Field {
                    name: "adc3_eoic",
                    description: Some(
                        "This bit is the mirror image of the EOIC bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
                ...
                Field {
                    name: "adc3_stic",
                    description: Some(
                        "This bit is the mirror image of the STIC bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 29,
                ...
                Field {
                    name: "adc3_strc",
                    description: Some(
                        "This bit is the mirror image of the STRC bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
                ...
                Field {
                    name: "adc3_rovf",
                    description: Some(
                        "This bit is the mirror image of the ROVF bit of ADC3",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "eoc",
                    description: Some(
                        "End of sequence conversion flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "eoic",
                    description: Some(
                        "End of inserted sequence conversion flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    name: "rovf",
                    description: Some(
                        "Routine data register overflow",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 5,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "syncdata0",
                    description: Some(
                        "Routine data 0 in ADC sync mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "syncdata1",
                    description: Some(
                        "Routine data 1 in ADC sync mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
