        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "pecfg",
                    description: Some(
                        "Page erase configuration register",
                    ),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "pekey",
                    description: Some(
                        "Unlock page erase key register",
                    ),
                    array: None,
                    byte_offset: 0x24,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pe_en",
                    description: Some(
                        "The enable bit of page erase function",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
