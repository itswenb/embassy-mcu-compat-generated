        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dhfmt0",
                    description: Some(
                        "DAC_OUT0 data format written in data holding register",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
                ...
                Field {
                    name: "dhfmt1",
                    description: Some(
                        "DAC_OUT1 data format written in data holding register",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 25,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sawinit0",
                    description: Some(
                        "DAC_OUT0 sawtooth initial value",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "sawdir0",
                    description: Some(
                        "DAC_OUT0 sawtooth step direction",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sawinit1",
                    description: Some(
                        "DAC_OUT1 sawtooth initial value",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "sawdir1",
                    description: Some(
                        "DAC_OUT1 sawtooth step direction",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "sawrsttsel0",
                    description: Some(
                        "DAC_OUT0 sawtooth reset to initial value trigger selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "sawsteptsel0",
                    description: Some(
                        "DAC_OUT0 sawtooth step-up/down trigger selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "sawrsttsel1",
                    description: Some(
                        "DAC_OUT1 sawtooth reset to initial value trigger selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "sawsteptsel1",
                    description: Some(
                        "DAC_OUT1 sawtooth step-up/down trigger selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tkeep0",
                    description: Some(
                        "DAC_OUT0 keep time (only available in sample and keep mode)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "tkeep1",
                    description: Some(
                        "DAC_OUT1 keep time (only available in sample and keep mode)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "tref0",
                    description: Some(
                        "DAC_OUT refresh time (only available in sample and keep mode)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "tref1",
                    description: Some(
                        "DAC_OUT1 refresh time (only available in sample and keep mode)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "bwt0",
                    description: Some(
                        "DAC_OUT0 TSAMP0[9:0] writing busy flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "bwt1",
                    description: Some(
                        "DAC_OUT1 TSAMP1[9:0] writing busy flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "swsttr0",
                    description: Some(
                        "DAC_OUT0 sawtooth step-up/down software trigger",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "swsttr1",
                    description: Some(
                        "DAC_OUT1 sawtooth step-up/down software trigger",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
