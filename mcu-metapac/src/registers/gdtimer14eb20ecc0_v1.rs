        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "afctl1",
                    description: Some(
                        "alternate function control register 1",
                    ),
                    array: None,
                    byte_offset: 0x90,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "brk0hpdfen",
                    description: Some(
                        "BREAK0 HPDF input (HPDF_BREAK[0]) enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dtmoden",
                    description: Some(
                        "Dead time modified on-the-fly enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ch0comctl_3",
                    description: Some(
                        "Bit 3 of channel 0 compare output control",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mch0comctl_3",
                    description: Some(
                        "Multi mode channel 0 compare output control(bit 3)",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
