        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ckoutdiv",
                    description: Some(
                        "The CK_OUT divider which the CK_OUT frequency can be reduced, see bits 26:24 of RCU_CFG0 for CK_OUT.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
                ...
                Field {
                    name: "plldv",
                    description: Some(
                        "The CK_PLL divide by 1 or 8 for CK_OUT",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 31,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adcsel",
                    description: Some(
                        "CK_ADCPRE clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 25,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "irc32mstb",
                    description: Some(
                        "IRC32M high speed internal oscillator stabilization flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "irc32madj",
                    description: Some(
                        "Internal 32M RC oscillator clock trim adjust value",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
                ...
                Field {
                    name: "irc32mcalib",
                    description: Some(
                        "Internal 32M RC oscillator calibration value register",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "hxtalrst",
                    description: Some(
                        "External high speed oscillator ready reset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "irc32mstbif",
                    description: Some(
                        "IRC32M stabilization interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    name: "pllmif",
                    description: Some(
                        "PLL clock monitor interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
                ...
                Field {
                    name: "irc32mstbie",
                    description: Some(
                        "IRC32M stabilization interrupt enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
                ...
                Field {
                    name: "pllmie",
                    description: Some(
                        "PLL clock monitor interrupt enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
                ...
                Field {
                    name: "irc32mstbic",
                    description: Some(
                        "IRC32M stabilization interrupt clear",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 18,
                ...
                Field {
                    name: "pllmic",
                    description: Some(
                        "PLL clock monitor interrupt clear",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 22,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lvd0rstf",
                    description: Some(
                        "Low voltage 0 detect error reset flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "lvd1rstf",
                    description: Some(
                        "Low voltage 1 detect error reset flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 19,
                ...
                Field {
                    name: "lvd2rstf",
                    description: Some(
                        "Low voltage 2 detect error reset flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
                ...
                Field {
                    name: "lohrstf",
                    description: Some(
                        "Lost of HXTAL error reset flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 21,
