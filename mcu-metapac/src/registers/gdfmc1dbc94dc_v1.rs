        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "efuse_cs",
                    description: Some(
                        "Efuse control and status register",
                    ),
                    array: None,
                    byte_offset: 0x200,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "efuse_user_data",
                    description: Some(
                        "Efuse user data register",
                    ),
                    array: None,
                    byte_offset: 0x20c,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dwpge",
                    description: Some(
                        "Double word program size bit enable.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
                ...
                Field {
                    name: "ldeccie",
                    description: Some(
                        "Load code ECC error interrupt enable bit.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
                ...
                Field {
                    name: "nwlde",
                    description: Some(
                        "Enable no wait time area load when system reset. This bit is only restored by power on reset.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 29,
                ...
                Field {
                    name: "rlbp",
                    description: Some(
                        "Read lock block protection for OTP2.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "efbyp",
                    description: Some(
                        "Efuse LDO bypass. This bit can be set only when EFSTR is 0. And users should make sure the external voltage supply is stable before seting EFSTR if set this bit. The program voltage should whitin 2.25V~2.75V. And typical voltage is 2.5V.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "efspc",
                    description: Some(
                        "Efuse Security protection. Forbid SPC from no protect to level low.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ldeccaddr0",
                    description: Some(
                        "ECC two bits error base address (aligned to 64bit) when load code from main flash / bootloader OTP1. Any bits in 64bit may be wrong.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "obkey",
                    description: Some(
                        "FMC_OBCTLx option byte operation unlock register",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ldeccdet",
                    description: Some(
                        "Two bits ECC error flag bit when load code.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    name: "rdcerr",
                    description: Some(
                        "Read CBUS protection error flag bit.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
