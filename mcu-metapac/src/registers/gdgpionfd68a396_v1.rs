        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "hldcfg",
                    description: Some(
                        "Pin level hold config register",
                    ),
                    array: None,
                    byte_offset: 0x50,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "hldctl",
                    description: Some(
                        "Pin level hold control register",
                    ),
                    array: None,
                    byte_offset: 0x64,
                    inner: BlockItemInner::Register(
