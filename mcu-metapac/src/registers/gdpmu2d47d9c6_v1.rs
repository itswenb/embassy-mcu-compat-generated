        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ovdt",
                    description: Some(
                        "Over Voltage Detector Threshold",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "sramsw1",
                    description: Some(
                        "SRAM1(16KB~32KB) power switch in deep-sleep mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
                ...
                Field {
                    name: "sramsw2",
                    description: Some(
                        "SRAM2(32KB~48KB) power switch in deep-sleep mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 21,
