        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "uesm",
                    description: Some(
                        "LPUART enable in Deep-sleep mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "ucesm",
                    description: Some(
                        "LPUART clock enable in Deep-sleep mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "wuc",
                    description: Some(
                        "Wakeup from Deep-sleep mode flag clear",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
