        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "slp_key",
                    description: Some(
                        "Unlock flash sleep/power down mode key register",
                    ),
                    array: None,
                    byte_offset: 0x24,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "sys_ecc",
                    description: Some(
                        "ECC bit error is detected in system memory",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 2,
                ...
                Field {
                    name: "mf_ecc",
                    description: Some(
                        "ECC bit error is detected in main Flash",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 3,
                ...
                Field {
                    name: "ob_ecc",
                    description: Some(
                        "ECC bit error is detected in reading option bytes",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 5,
                ...
                Field {
                    name: "obeccdet",
                    description: Some(
                        "Option bytes two bits errors detect flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "run_slp",
                    description: Some(
                        "Flash enter sleep/power-down mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    name: "sleep_slp",
                    description: Some(
                        "Flash enter sleep mode or power-down mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
