        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "pllall",
                    description: Some(
                        "PLL all configuration register",
                    ),
                    array: None,
                    byte_offset: 0x98,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "spi0sel",
                    description: Some(
                        "SPI0 / I2S0 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "spi1sel",
                    description: Some(
                        "SPI1 / I2S1 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "spi2sel",
                    description: Some(
                        "SPI2 / I2S2 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "spi5sel",
                    description: Some(
                        "SPI5 / I2S5 clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
