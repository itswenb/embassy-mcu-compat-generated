        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "vbaten",
                    description: Some(
                        "Channel 11 (1/4 voltage of external battery) enable of ADC0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 22,
                ...
                Field {
                    name: "inrefen",
                    description: Some(
                        "Channel 10 (internal reference voltage) enable of ADC0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
                ...
                Field {
                    name: "tsven",
                    description: Some(
                        "Channel 9 (temperature sensor) enable of ADC.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "idma",
                    description: Some(
                        "DMA request enable for inserted sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
                ...
                Field {
                    name: "rdma",
                    description: Some(
                        "DMA request enable for routine sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
                ...
                Field {
                    name: "rddm",
                    description: Some(
                        "DMA disable mode for routine sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
                ...
                Field {
                    name: "eorcm",
                    description: Some(
                        "End of routine conversion mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 10,
                ...
                Field {
                    name: "iddm",
                    description: Some(
                        "DMA disable mode for inserted sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    name: "etsic",
                    description: Some(
                        "External trigger select for inserted sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "etmic",
                    description: Some(
                        "External trigger mode for inserted sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
                ...
                Field {
                    name: "etmrc",
                    description: Some(
                        "External trigger mode for routine sequence",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 28,
                ...
                Field {
                    name: "swrcst",
                    description: Some(
                        "Software start on routine sequence.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 30,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "isq0",
                    description: Some(
                        "The channel number (0..14) is written to these bits to select a channel as the nth conversion in the inserted sequence.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "rsq0",
                    description: Some(
                        "The channel number (0..14) is written to these bits to select a channel as the nth conversion in the routine sequence.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "iovf",
                    description: Some(
                        "Inserted data register overflow",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
