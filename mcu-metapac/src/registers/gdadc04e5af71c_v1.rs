        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "ioff0",
                    description: Some(
                        "Inserted channel data offset register0",
                    ),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rwd0en",
                    description: Some(
                        "Regular channel analog watchdog 0 \t enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "difctl_14_0",
                    description: Some(
                        "Differential mode for channel 14 to 0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "difctl_17_15",
                    description: Some(
                        "Differential mode for channel 17 to 15",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "ioff",
                    description: Some(
                        "Data offset for inserted channel0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wdht0",
                    description: Some(
                        "Analog watchdog 0 higher threshold",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wdlt0",
                    description: Some(
                        "Analog watchdog 0 lower threshold",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
