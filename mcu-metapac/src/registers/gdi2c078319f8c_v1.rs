        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "arpen",
                    description: Some(
                        "ARP protocol enable in SMBus mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tff",
                    description: Some(
                        "Txframe fall flag, cleared by software by writing 0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
                ...
                Field {
                    name: "tfr",
                    description: Some(
                        "Txframe rise flag, cleared by software by writing 0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    name: "rff",
                    description: Some(
                        "Rxframe fall flag, cleared by software by writing 0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
                ...
                Field {
                    name: "rfr",
                    description: Some(
                        "Rxframe rise flag, cleared by software by writing 0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "addsend",
                    description: Some(
                        "Address is sent and ACK is received in master mode or address is received and matches with its own address in slave mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
                ...
                Field {
                    name: "ouerr",
                    description: Some(
                        "Over-run or under-run situation occurs in slave mode, when SCL stretching is disabled",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 11,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "dumodf",
                    description: Some(
                        "Dual flag in slave mode indicates which address matches with the address in Dual-Address mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
