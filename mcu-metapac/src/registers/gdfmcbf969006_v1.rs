        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "secmcfg2",
                    description: Some(
                        "Secure mark configuration register",
                    ),
                    array: None,
                    byte_offset: 0x60,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "obwen",
                    description: Some(
                        "FMC_OBR / FMC_OBUSER / FMC_SECMx (x=0,1,2,3) / FMC_NODECx (x=0,1,2,3) / FMC_OFRG / FMC_OFVR / FMC_OBWRPx (x=0,1) write enable bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secm0_spage",
                    description: Some(
                        "Start page of secure mark area 0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "secm0_epage",
                    description: Some(
                        "End page of secure mark area 0.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secm1_spage",
                    description: Some(
                        "Start page of secure mark area 1.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "secm1_epage",
                    description: Some(
                        "End page of secure mark area 1.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secm2_spage",
                    description: Some(
                        "Start page of secure mark area 2.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "secm2_epage",
                    description: Some(
                        "End page of secure mark area 2.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "secm3_spage",
                    description: Some(
                        "Start page of secure mark area 3.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "secm3_epage",
                    description: Some(
                        "End page of secure mark area 3.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
