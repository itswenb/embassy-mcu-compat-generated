        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "chgt",
                    description: Some(
                        "The latest time that VBUS ramps from VADPSINK to VADPPRB",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
                ...
                Field {
                    name: "adpprfm",
                    description: Some(
                        "The mask of ADP probe interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 24,
                ...
                Field {
                    name: "adpsnfm",
                    description: Some(
                        "The mask of ADP sense interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 25,
                ...
                Field {
                    name: "adptfm",
                    description: Some(
                        "The mask of ADP timeout interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 26,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "burst",
                    description: Some(
                        "The AHB burst type used by DMA",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 1,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "bcden",
                    description: Some(
                        "Battery charging detection enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 12,
                ...
                Field {
                    name: "dcdmen",
                    description: Some(
                        "Data connect detection mode enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 13,
                ...
                Field {
                    name: "vden",
                    description: Some(
                        "Enable of VBUS sensing comparator to detect VBUS valid",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 21,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "rsok",
                    description: Some(
                        "Resume can be sent after sleep state",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
                ...
                Field {
                    name: "lpmchi",
                    description: Some(
                        "Channel number index when send LPM transaction",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "avoe",
                    description: Some(
                        "Override enable of A-peripheral session valid",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "avov",
                    description: Some(
                        "Override value of A-peripheral session valid",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 5,
                ...
                Field {
                    name: "bvoe",
                    description: Some(
                        "Override enable of B-peripheral session valid",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
                ...
                Field {
                    name: "bvov",
                    description: Some(
                        "Override value of B-peripheral session valid",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "idchg",
                    description: Some(
                        "There is a change in the value of ID input",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 20,
