        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "l0hpos",
                    description: Some(
                        "Layer 0 horizontal position parameters regist",
                    ),
                    array: None,
                    byte_offset: 0x88,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0vpos",
                    description: Some(
                        "Layer 0 vertical position parameters regist",
                    ),
                    array: None,
                    byte_offset: 0x8c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0ppf",
                    description: Some(
                        "Layer 0 packeted pixel format regist",
                    ),
                    array: None,
                    byte_offset: 0x94,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0sa",
                    description: Some(
                        "Layer 0 specified alpha regist",
                    ),
                    array: None,
                    byte_offset: 0x98,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0fbaddr",
                    description: Some(
                        "Layer 0 frame base address regist",
                    ),
                    array: None,
                    byte_offset: 0xac,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0fllen",
                    description: Some(
                        "Layer 0 frame line length regist",
                    ),
                    array: None,
                    byte_offset: 0xb0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l0ftln",
                    description: Some(
                        "Layer 0 frame total line number regist",
                    ),
                    array: None,
                    byte_offset: 0xb4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1hpos",
                    description: Some(
                        "Layer 1 horizontal position parameters regist",
                    ),
                    array: None,
                    byte_offset: 0x108,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1vpos",
                    description: Some(
                        "Layer 1 vertical position parameters regist",
                    ),
                    array: None,
                    byte_offset: 0x10c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1ppf",
                    description: Some(
                        "Layer 1 packeted pixel format regist",
                    ),
                    array: None,
                    byte_offset: 0x114,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1sa",
                    description: Some(
                        "Layer 1 specified alpha regist",
                    ),
                    array: None,
                    byte_offset: 0x118,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1fbaddr",
                    description: Some(
                        "Layer 1 frame base address regist",
                    ),
                    array: None,
                    byte_offset: 0x12c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1fllen",
                    description: Some(
                        "Layer 1 frame line length regist",
                    ),
                    array: None,
                    byte_offset: 0x130,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "l1ftln",
                    description: Some(
                        "Layer 1 frame total line number regist",
                    ),
                    array: None,
                    byte_offset: 0x134,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "vtsz",
                    description: Some(
                        "Vertical total size of the display, including active area, back porch, synchronous pulse and front porch",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "htsz",
                    description: Some(
                        "Horizontal total size of the display, including active area, back porch, synchronous pulse and front porch",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
