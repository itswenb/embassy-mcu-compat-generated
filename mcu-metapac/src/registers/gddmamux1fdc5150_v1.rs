        ...
        Block {
            ...
            items: &[
                BlockItem {
                    name: "rm_ch0cfg",
                    description: Some(
                        "Request multiplexer channel 0 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x0,
                ...
                BlockItem {
                    name: "rm_ch1cfg",
                    description: Some(
                        "Request multiplexer channel 1 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch2cfg",
                    description: Some(
                        "Request multiplexer channel 2 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch3cfg",
                    description: Some(
                        "Request multiplexer channel 3 configuration register",
                    ),
                    array: None,
                    byte_offset: 0xc,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch4cfg",
                    description: Some(
                        "Request multiplexer channel 4 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x10,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch5cfg",
                    description: Some(
                        "Request multiplexer channel 5 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x14,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch6cfg",
                    description: Some(
                        "Request multiplexer channel 6 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x18,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch7cfg",
                    description: Some(
                        "Request multiplexer channel 7 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x1c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch8cfg",
                    description: Some(
                        "Request multiplexer channel 8 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch9cfg",
                    description: Some(
                        "Request multiplexer channel 9 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x24,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch10cfg",
                    description: Some(
                        "Request multiplexer channel 10 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x28,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch11cfg",
                    description: Some(
                        "Request multiplexer channel 11 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x2c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch12cfg",
                    description: Some(
                        "Request multiplexer channel 12 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x30,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rm_ch13cfg",
                    description: Some(
                        "Request multiplexer channel 13 configuration register",
                    ),
                    array: None,
                    byte_offset: 0x34,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "rg_intc",
                    description: Some(
                        "Request generator interrupt flag clear register",
                    ),
                    array: None,
                    byte_offset: 0x144,
                    inner: BlockItemInner::Register(
