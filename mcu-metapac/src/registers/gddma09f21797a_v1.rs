        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "ch0paddr",
                    description: Some(
                        "Channel 0 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x18,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch0m0addr",
                    description: Some(
                        "Channel 0 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x1c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch0m1addr",
                    description: Some(
                        "Channel 0 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x20,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch1paddr",
                    description: Some(
                        "Channel 1 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x30,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch1m0addr",
                    description: Some(
                        "Channel 1 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x34,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch1m1addr",
                    description: Some(
                        "Channel 1 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x38,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch2paddr",
                    description: Some(
                        "Channel 2 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x48,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch2m0addr",
                    description: Some(
                        "Channel 2 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x4c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch2m1addr",
                    description: Some(
                        "Channel 2 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x50,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch3paddr",
                    description: Some(
                        "Channel 3 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x60,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch3m0addr",
                    description: Some(
                        "Channel 3 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x64,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch3m1addr",
                    description: Some(
                        "Channel 3 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x68,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch4paddr",
                    description: Some(
                        "Channel 4 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x78,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch4m0addr",
                    description: Some(
                        "Channel 4 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x7c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch4m1addr",
                    description: Some(
                        "Channel 4 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x80,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch5paddr",
                    description: Some(
                        "Channel 5 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0x90,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch5m0addr",
                    description: Some(
                        "Channel 5 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x94,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch5m1addr",
                    description: Some(
                        "Channel 5 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0x98,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch6paddr",
                    description: Some(
                        "Channel 6 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0xa8,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch6m0addr",
                    description: Some(
                        "Channel 6 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0xac,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch6m1addr",
                    description: Some(
                        "Channel 6 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0xb0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch7paddr",
                    description: Some(
                        "Channel 7 peripheral base address regist",
                    ),
                    array: None,
                    byte_offset: 0xc0,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch7m0addr",
                    description: Some(
                        "Channel 7 memory 0 base address regist",
                    ),
                    array: None,
                    byte_offset: 0xc4,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "ch7m1addr",
                    description: Some(
                        "Channel 7 memory 1 base address regist",
                    ),
                    array: None,
                    byte_offset: 0xc8,
                    inner: BlockItemInner::Register(
