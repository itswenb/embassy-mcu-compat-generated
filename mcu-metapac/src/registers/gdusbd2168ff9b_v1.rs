        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "l1reqie",
                    description: Some(
                        "LPM L1 state request interrupt enable",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "tx_dtg",
                    description: Some(
                        "Data PID Toggle, for transmission transfers",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "l1req",
                    description: Some(
                        "LPM L1 transaction is successful",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
                ...
                Field {
                    name: "pmouif",
                    description: Some(
                        "Packet memory area over / underrun interrupt flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 14,
