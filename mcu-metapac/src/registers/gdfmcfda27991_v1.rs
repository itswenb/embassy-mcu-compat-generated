        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "wp0",
                    description: Some(
                        "Write protection area 0 register",
                    ),
                    array: None,
                    byte_offset: 0x2c,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "wp1",
                    description: Some(
                        "Write protection area 1 register",
                    ),
                    array: None,
                    byte_offset: 0x30,
                    inner: BlockItemInner::Register(
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dcrp0_eaddr",
                    description: Some(
                        "DCRP area 0 end address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dcrp1_eaddr",
                    description: Some(
                        "DCRP area 1 end address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "dcrp1_saddr",
                    description: Some(
                        "DCRP area 1 start address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "borr_th",
                    description: Some(
                        "BOR threshold at rising VDD supply",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
                ...
                Field {
                    name: "borf_th",
                    description: Some(
                        "BOR threshold at falling VDD supply",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 11,
                ...
                Field {
                    name: "n_wwdg_hw",
                    description: Some(
                        "Window watchdog configuration bit",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 19,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "scr_page_cnt",
                    description: Some(
                        "Configure the number of pages in secure user area.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pgmerr",
                    description: Some(
                        "Program size not match error flag bit. This bit is set by hardware when program size is a half-word/word access. The only correct programming size is double word.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 6,
                ...
                Field {
                    name: "fstperr",
                    description: Some(
                        "Fast programming error flag bit.",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 9,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wp0_saddr",
                    description: Some(
                        "Write protection area 0 end address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
        ...
        FieldSet {
            ...
            fields: &[
                Field {
                    name: "wp1_saddr",
                    description: Some(
                        "Write protection area 1 start address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "wp1_eaddr",
                    description: Some(
                        "Write protection area 1 end address offset",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mfpe",
                    description: Some(
                        "Main flash programmed or empty flag",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 16,
