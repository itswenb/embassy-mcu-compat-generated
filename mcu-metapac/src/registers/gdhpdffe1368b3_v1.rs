    ...
    fieldsets: &[
        ...
        FieldSet {
            name: "HpdfFltsumtmctl",
            extends: None,
            description: None,
            bit_size: 32,
            fields: &[
                Field {
                    name: "hpdf_fltsumtmctl_cdasel",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
                ...
                Field {
                    name: "hpdf_fltsumtmctl_tmfdasel",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 4,
                ...
                Field {
                    name: "hpdf_fltsumtmctl_tmfdbsel",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 7,
        ...
        FieldSet {
            name: "HpdfFltsumtmstat",
            extends: None,
            description: None,
            bit_size: 32,
            fields: &[
                Field {
                    name: "hpdf_fltsumtmstat_sltf",
                    description: None,
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 0,
