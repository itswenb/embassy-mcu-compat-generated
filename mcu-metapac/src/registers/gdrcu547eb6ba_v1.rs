        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "adcspen",
                    description: Some(
                        "ADC clock enable when sleep mode",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 8,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "lxtalstron",
                    description: Some(
                        "LXTAL start circuit open off control",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 17,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "mcosel",
                    description: Some(
                        "CKOUT0/CKOUT1 clock source High-precision clock",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 23,
        ...
        FieldSet {
            ...
            fields: &[
                ...
                Field {
                    name: "pllsel_0",
                    description: Some(
                        "PLL (PLLsys and PLLI2S) clock source selection",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 15,
                ...
                Field {
                    name: "pllsel_1",
                    description: Some(
                        "Configure clock source selection together with PLLSEL_0",
                    ),
                    bit_offset: BitOffset::Regular(
                        RegularBitOffset {
                            offset: 18,
