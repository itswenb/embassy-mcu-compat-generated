...
pub mod regs {
    ...
    impl defmt::Format for Ahbenr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ahbenr {{ dma1en: {=bool:?}, dma2en: {=bool:?}, sramen: {=bool:?}, flashen: {=bool:?}, crcen: {=bool:?}, fsmcen: {=bool:?}, sdioen: {=bool:?} }}",
                self.dma1en(),
                self.dma2en(),
                self.sramen(),
                self.flashen(),
    ...
    impl defmt::Format for Apb1enr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb1enr {{ tim2en: {=bool:?}, tim3en: {=bool:?}, tim4en: {=bool:?}, tim5en: {=bool:?}, tim6en: {=bool:?}, tim7en: {=bool:?}, tim12en: {=bool:?}, tim13en: {=bool:?}, tim14en: {=bool:?}, wwdgen: {=bool:?}, spi2en: {=bool:?}, spi3en: {=bool:?}, usart2en: {=bool:?}, usart3en: {=bool:?}, uart4en: {=bool:?}, uart5en: {=bool:?}, i2c1en: {=bool:?}, i2c2en: {=bool:?}, usben: {=bool:?}, canen: {=bool:?}, bkpen: {=bool:?}, pwren: {=bool:?}, dacen: {=bool:?} }}",
                self.tim2en(),
                self.tim3en(),
                self.tim4en(),
                self.tim5en(),
    ...
    impl defmt::Format for Apb1rstr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Apb1rstr {{ tim2rst: {=bool:?}, tim3rst: {=bool:?}, tim4rst: {=bool:?}, tim5rst: {=bool:?}, tim6rst: {=bool:?}, tim7rst: {=bool:?}, tim12rst: {=bool:?}, tim13rst: {=bool:?}, tim14rst: {=bool:?}, wwdgrst: {=bool:?}, spi2rst: {=bool:?}, spi3rst: {=bool:?}, usart2rst: {=bool:?}, usart3rst: {=bool:?}, uart4rst: {=bool:?}, uart5rst: {=bool:?}, i2c1rst: {=bool:?}, i2c2rst: {=bool:?}, usbrst: {=bool:?}, canrst: {=bool:?}, bkprst: {=bool:?}, pwrrst: {=bool:?}, dacrst: {=bool:?} }}",
                self.tim2rst(),
                self.tim3rst(),
                self.tim4rst(),
                self.tim5rst(),
    ...
    impl defmt::Format for Rccahben {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccahben {{ dma0en: {=bool:?}, dma1en: {=bool:?}, sramspen: {=bool:?}, fmcspen: {=bool:?}, crcen: {=bool:?}, exmcen: {=bool:?}, sdioen: {=bool:?} }}",
                self.dma0en(),
                self.dma1en(),
                self.sramspen(),
                self.fmcspen(),
    ...
    impl Rccapb1en {
        ...
        #[doc = "USBD clock enable"]
        #[inline(always)]
        pub const fn set_usbden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
    ...
    impl defmt::Format for Rccapb1en {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccapb1en {{ timer1en: {=bool:?}, timer2en: {=bool:?}, timer3en: {=bool:?}, timer4en: {=bool:?}, timer5en: {=bool:?}, timer6en: {=bool:?}, timer11en: {=bool:?}, timer12en: {=bool:?}, timer13en: {=bool:?}, wwdgten: {=bool:?}, spi1en: {=bool:?}, spi2en: {=bool:?}, usart1en: {=bool:?}, usart2en: {=bool:?}, uart3en: {=bool:?}, uart4en: {=bool:?}, i2c0en: {=bool:?}, i2c1en: {=bool:?}, usbden: {=bool:?}, can0en: {=bool:?}, bkpien: {=bool:?}, pmuen: {=bool:?}, dacen: {=bool:?} }}",
                self.timer1en(),
                self.timer2en(),
                self.timer3en(),
                self.timer4en(),
    ...
    impl Rccapb1rst {
        ...
        #[doc = "USBD reset"]
        #[inline(always)]
        pub const fn set_usbdrst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
        #[doc = "CAN0 reset"]
        #[must_use]
    ...
    impl defmt::Format for Rccapb1rst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccapb1rst {{ timer1rst: {=bool:?}, timer2rst: {=bool:?}, timer3rst: {=bool:?}, timer4rst: {=bool:?}, timer5rst: {=bool:?}, timer6rst: {=bool:?}, timer11rst: {=bool:?}, timer12rst: {=bool:?}, timer13rst: {=bool:?}, wwdgtrst: {=bool:?}, spi1rst: {=bool:?}, spi2rst: {=bool:?}, usart1rst: {=bool:?}, usart2rst: {=bool:?}, uart3rst: {=bool:?}, uart4rst: {=bool:?}, i2c0rst: {=bool:?}, i2c1rst: {=bool:?}, usbdrst: {=bool:?}, can0rst: {=bool:?}, bkpirst: {=bool:?}, pmurst: {=bool:?}, dacrst: {=bool:?} }}",
                self.timer1rst(),
                self.timer2rst(),
                self.timer3rst(),
                self.timer4rst(),
    ...
    impl Rcccfg0 {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn predv0(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "PREDV0 division factor"]
        #[inline(always)]
        pub const fn set_predv0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        ...
        #[must_use]
        #[inline(always)]
        pub const fn usbdpsc_1_0(&self) -> u8 {
            let val = (self.0 >> 22usize) & 0x03;
            val as u8
        }
        #[doc = "USBD clock prescaler selection"]
        #[inline(always)]
        pub const fn set_usbdpsc_1_0(&mut self, val: u8) {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn pllmf_4(&self) -> bool {
            let val = (self.0 >> 27usize) & 0x01;
            val != 0
        }
        #[doc = "Bit 4 of PLLMF"]
        #[inline(always)]
        pub const fn set_pllmf_4(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 27usize)) | (((val as u32) & 0x01) << 27usize);
        }
        #[doc = "Bit 2 of ADCPSC"]
        #[must_use]
        ...
        #[must_use]
        #[inline(always)]
        pub const fn pllmf_5(&self) -> bool {
            let val = (self.0 >> 30usize) & 0x01;
            val != 0
        }
        #[doc = "Bit 5 of PLLMF"]
        #[inline(always)]
        pub const fn set_pllmf_5(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize);
        }
        #[doc = "Bit 2 of USBDPSC"]
        #[must_use]
        #[inline(always)]
        pub const fn usbdpsc_2(&self) -> bool {
            let val = (self.0 >> 31usize) & 0x01;
            val != 0
        }
        #[doc = "Bit 2 of USBDPSC"]
        #[inline(always)]
        pub const fn set_usbdpsc_2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl core::fmt::Debug for Rcccfg0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rcccfg0")
                ...
                .field("usbdpsc_1_0", &self.usbdpsc_1_0())
                .field("ckout0sel", &self.ckout0sel())
                .field("pllmf_4", &self.pllmf_4())
                .field("adcpsc_2", &self.adcpsc_2())
                .field("pllmf_5", &self.pllmf_5())
                .field("usbdpsc_2", &self.usbdpsc_2())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Rcccfg0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rcccfg0 {{ scs: {=u8:?}, scss: {=u8:?}, ahbpsc: {=u8:?}, apb1psc: {=u8:?}, apb2psc: {=u8:?}, adcpsc_1_0: {=u8:?}, pllsel: {=bool:?}, predv0: {=bool:?}, pllmf_3_0: {=u8:?}, usbdpsc_1_0: {=u8:?}, ckout0sel: {=u8:?}, pllmf_4: {=bool:?}, adcpsc_2: {=bool:?}, pllmf_5: {=bool:?}, usbdpsc_2: {=bool:?} }}",
                self.scs(),
                self.scss(),
                self.ahbpsc(),
                self.apb1psc(),
    ...
    impl defmt::Format for Rcccfg1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rcccfg1 {{ adcpsc_3: {=bool:?}, pllpresel: {=bool:?} }}",
                self.adcpsc_3(),
                self.pllpresel()
            )
        }
    ...
    impl defmt::Format for Rccctl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccctl {{ irc8men: {=bool:?}, irc8mstb: {=bool:?}, irc8madj: {=u8:?}, irc8mcalib: {=u8:?}, hxtalen: {=bool:?}, hxtalstb: {=bool:?}, hxtalbps: {=bool:?}, ckmen: {=bool:?}, pllen: {=bool:?}, pllstb: {=bool:?} }}",
                self.irc8men(),
                self.irc8mstb(),
                self.irc8madj(),
                self.irc8mcalib(),
    ...
    impl defmt::Format for Rccint {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccint {{ irc40kstbif: {=bool:?}, lxtalstbif: {=bool:?}, irc8mstbif: {=bool:?}, hxtalstbif: {=bool:?}, pllstbif: {=bool:?}, ckmif: {=bool:?}, irc40kstbie: {=bool:?}, lxtalstbie: {=bool:?}, irc8mstbie: {=bool:?}, hxtalstbie: {=bool:?}, pllstbie: {=bool:?}, irc40kstbic: {=bool:?}, lxtalstbic: {=bool:?}, irc8mstbic: {=bool:?}, hxtalstbic: {=bool:?}, pllstbic: {=bool:?}, ckmic: {=bool:?} }}",
                self.irc40kstbif(),
                self.lxtalstbif(),
                self.irc8mstbif(),
                self.hxtalstbif(),
    ...
    impl Rccrcuahben {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_ahben_sdioen(&self) -> bool {
            let val = (self.0 >> 10usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_ahben_sdioen(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
    }
    ...
    impl core::fmt::Debug for Rccrcuahben {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcuahben")
                ...
                .field("rcu_ahben_sdioen", &self.rcu_ahben_sdioen())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Rccrcuahben {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccrcuahben {{ rcu_ahben_dma0en: {=bool:?}, rcu_ahben_dma1en: {=bool:?}, rcu_ahben_sramspen: {=bool:?}, rcu_ahben_fmcspen: {=bool:?}, rcu_ahben_crcen: {=bool:?}, rcu_ahben_exmcen: {=bool:?}, rcu_ahben_sdioen: {=bool:?} }}",
    ...
    impl Rccrcuapb1en {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_apb1en_usbden(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_apb1en_usbden(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl core::fmt::Debug for Rccrcuapb1en {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcuapb1en")
                ...
                .field("rcu_apb1en_usbden", &self.rcu_apb1en_usbden())
    ...
    impl Rccrcuapb1rst {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_apb1rst_usbdrst(&self) -> bool {
            let val = (self.0 >> 23usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_apb1rst_usbdrst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 23usize)) | (((val as u32) & 0x01) << 23usize);
        }
        #[must_use]
        #[inline(always)]
    ...
    impl core::fmt::Debug for Rccrcuapb1rst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcuapb1rst")
                ...
                .field("rcu_apb1rst_usbdrst", &self.rcu_apb1rst_usbdrst())
    ...
    impl defmt::Format for Rccrcuapb1rst {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccrcuapb1rst {{ rcu_apb1rst_timer1rst: {=bool:?}, rcu_apb1rst_timer2rst: {=bool:?}, rcu_apb1rst_timer3rst: {=bool:?}, rcu_apb1rst_timer4rst: {=bool:?}, rcu_apb1rst_timer5rst: {=bool:?}, rcu_apb1rst_timer6rst: {=bool:?}, rcu_apb1rst_wwdgtrst: {=bool:?}, rcu_apb1rst_spi1rst: {=bool:?}, rcu_apb1rst_spi2rst: {=bool:?}, rcu_apb1rst_usart1rst: {=bool:?}, rcu_apb1rst_usart2rst: {=bool:?}, rcu_apb1rst_uart3rst: {=bool:?}, rcu_apb1rst_uart4rst: {=bool:?}, rcu_apb1rst_i2c0rst: {=bool:?}, rcu_apb1rst_i2c1rst: {=bool:?}, rcu_apb1rst_usbdrst: {=bool:?}, rcu_apb1rst_can0rst: {=bool:?}, rcu_apb1rst_bkpirst: {=bool:?}, rcu_apb1rst_pmurst: {=bool:?}, rcu_apb1rst_dacrst: {=bool:?} }}",
    ...
    impl Rccrcuapb2en {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_apb2en_adc2en(&self) -> bool {
            let val = (self.0 >> 15usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_apb2en_adc2en(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
    }
    ...
    impl core::fmt::Debug for Rccrcuapb2en {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcuapb2en")
                ...
                .field("rcu_apb2en_adc2en", &self.rcu_apb2en_adc2en())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl Rccrcuapb2rst {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_apb2rst_adc2rst(&self) -> bool {
            let val = (self.0 >> 15usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_apb2rst_adc2rst(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 15usize)) | (((val as u32) & 0x01) << 15usize);
        }
    }
    ...
    impl core::fmt::Debug for Rccrcuapb2rst {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcuapb2rst")
                ...
                .field("rcu_apb2rst_adc2rst", &self.rcu_apb2rst_adc2rst())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl Rccrcucfg0 {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_cfg0_predv0(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_cfg0_predv0(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_cfg0_usbdpsc(&self) -> u8 {
            let val = (self.0 >> 22usize) & 0x03;
            val as u8
        }
        #[inline(always)]
        pub const fn set_rcu_cfg0_usbdpsc(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 22usize)) | (((val as u32) & 0x03) << 22usize);
        }
        #[must_use]
        #[inline(always)]
        ...
        #[must_use]
        #[inline(always)]
        pub const fn rcu_cfg0_usbdpsc_2(&self) -> bool {
            let val = (self.0 >> 31usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_rcu_cfg0_usbdpsc_2(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 31usize)) | (((val as u32) & 0x01) << 31usize);
        }
    }
    ...
    impl core::fmt::Debug for Rccrcucfg0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Rccrcucfg0")
                ...
                .field("rcu_cfg0_predv0", &self.rcu_cfg0_predv0())
                .field("rcu_cfg0_pllmf", &self.rcu_cfg0_pllmf())
                .field("rcu_cfg0_usbdpsc", &self.rcu_cfg0_usbdpsc())
                ...
                .field("rcu_cfg0_usbdpsc_2", &self.rcu_cfg0_usbdpsc_2())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Rccrcucfg0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccrcucfg0 {{ rcu_cfg0_scs: {=u8:?}, rcu_cfg0_scss: {=u8:?}, rcu_cfg0_ahbpsc: {=u8:?}, rcu_cfg0_apb1psc: {=u8:?}, rcu_cfg0_apb2psc: {=u8:?}, rcu_cfg0_adcpsc: {=u8:?}, rcu_cfg0_pllsel: {=bool:?}, rcu_cfg0_predv0: {=bool:?}, rcu_cfg0_pllmf: {=u8:?}, rcu_cfg0_usbdpsc: {=u8:?}, rcu_cfg0_ckout0sel: {=u8:?}, rcu_cfg0_pllmf_4: {=bool:?}, rcu_cfg0_adcpsc_2: {=bool:?}, rcu_cfg0_pllmf_5: {=bool:?}, rcu_cfg0_usbdpsc_2: {=bool:?} }}",
                self.rcu_cfg0_scs(),
                self.rcu_cfg0_scss(),
    ...
    impl defmt::Format for Rccrcucfg1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccrcucfg1 {{ rcu_cfg1_adcpsc_3: {=bool:?}, rcu_cfg1_pllpresel: {=bool:?} }}",
    ...
    impl defmt::Format for Rccrcuctl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Rccrcuctl {{ rcu_ctl_irc8men: {=bool:?}, rcu_ctl_irc8mstb: {=bool:?}, rcu_ctl_irc8madj: {=u8:?}, rcu_ctl_irc8mcalib: {=u8:?}, rcu_ctl_hxtalen: {=bool:?}, rcu_ctl_hxtalstb: {=bool:?}, rcu_ctl_hxtalbps: {=bool:?}, rcu_ctl_ckmen: {=bool:?}, rcu_ctl_pllen: {=bool:?}, rcu_ctl_pllstb: {=bool:?} }}",
