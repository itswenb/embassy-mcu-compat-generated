...
pub mod regs {
    ...
    impl defmt::Format for Mapr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Mapr {{ spi1_remap: {=bool:?}, i2c1_remap: {=bool:?}, usart1_remap: {=bool:?}, usart3_remap: {=u8:?}, tim1_remap: {=u8:?}, tim2_remap: {=u8:?}, tim3_remap: {=u8:?}, can1_remap: {=u8:?}, can2_remap: {=bool:?}, mii_rmii_sel: {=bool:?}, swj_cfg: {:?}, spi3_remap: {=bool:?}, ptp_pps_remap: {=bool:?} }}",
                self.spi1_remap(),
                self.i2c1_remap(),
                self.usart1_remap(),
                self.usart3_remap(),
