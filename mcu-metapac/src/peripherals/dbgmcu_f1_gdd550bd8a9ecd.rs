...
pub mod regs {
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ dbg_sleep: {=bool:?}, dbg_stop: {=bool:?}, dbg_standby: {=bool:?}, trace_ioen: {=bool:?}, iwdg: {=bool:?}, wwdg: {=bool:?}, tim1: {=bool:?}, tim2: {=bool:?}, tim3: {=bool:?}, tim4: {=bool:?}, can1: {=bool:?}, dbg_i2c1_smbus_timeout: {=bool:?}, dbg_i2c2_smbus_timeout: {=bool:?}, tim8: {=bool:?}, tim5: {=bool:?}, tim6: {=bool:?}, tim7: {=bool:?}, can2: {=bool:?}, tim12: {=bool:?}, tim13: {=bool:?}, tim14: {=bool:?} }}",
                self.dbg_sleep(),
                self.dbg_stop(),
                self.dbg_standby(),
                self.trace_ioen(),
