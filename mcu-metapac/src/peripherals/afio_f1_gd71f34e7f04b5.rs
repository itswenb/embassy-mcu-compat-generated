...
pub mod regs {
    ...
    impl Afioafiopcf0 {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn afio_pcf0_can_remap(&self) -> u8 {
            let val = (self.0 >> 13usize) & 0x03;
            val as u8
        }
        #[inline(always)]
        pub const fn set_afio_pcf0_can_remap(&mut self, val: u8) {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn afio_pcf0_adc0_etrgins_remap(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_afio_pcf0_adc0_etrgins_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[must_use]
        #[inline(always)]
        pub const fn afio_pcf0_adc0_etrgrou_remap(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_afio_pcf0_adc0_etrgrou_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
        #[must_use]
        #[inline(always)]
        pub const fn afio_pcf0_adc1_etrgins_remap(&self) -> bool {
            let val = (self.0 >> 19usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_afio_pcf0_adc1_etrgins_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 19usize)) | (((val as u32) & 0x01) << 19usize);
        }
        #[must_use]
        #[inline(always)]
        pub const fn afio_pcf0_adc1_etrgrou_remap(&self) -> bool {
            let val = (self.0 >> 20usize) & 0x01;
            val != 0
        }
        #[inline(always)]
        pub const fn set_afio_pcf0_adc1_etrgrou_remap(&mut self, val: bool) {
    ...
    impl core::fmt::Debug for Afioafiopcf0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Afioafiopcf0")
                ...
                .field("afio_pcf0_can_remap", &self.afio_pcf0_can_remap())
                .field("afio_pcf0_pd01_remap", &self.afio_pcf0_pd01_remap())
                .field("afio_pcf0_timer4ch3_iremap", &self.afio_pcf0_timer4ch3_iremap())
                .field("afio_pcf0_adc0_etrgins_remap", &self.afio_pcf0_adc0_etrgins_remap())
                .field("afio_pcf0_adc0_etrgrou_remap", &self.afio_pcf0_adc0_etrgrou_remap())
                .field("afio_pcf0_adc1_etrgins_remap", &self.afio_pcf0_adc1_etrgins_remap())
                .field("afio_pcf0_adc1_etrgrou_remap", &self.afio_pcf0_adc1_etrgrou_remap())
    ...
    impl defmt::Format for Afioafiopcf0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                ...
                self.afio_pcf0_can_remap(),
                self.afio_pcf0_pd01_remap(),
                self.afio_pcf0_timer4ch3_iremap(),
                self.afio_pcf0_adc0_etrgins_remap(),
                self.afio_pcf0_adc0_etrgrou_remap(),
                self.afio_pcf0_adc1_etrgins_remap(),
                self.afio_pcf0_adc1_etrgrou_remap(),
    ...
    impl Afiopcf0 {
        ...
        #[doc = "CAN interface remapping"]
        #[must_use]
        #[inline(always)]
        pub const fn can_remap(&self) -> u8 {
            let val = (self.0 >> 13usize) & 0x03;
            val as u8
        }
        #[doc = "CAN interface remapping"]
        #[inline(always)]
        pub const fn set_can_remap(&mut self, val: u8) {
            self.0 = (self.0 & !(0x03 << 13usize)) | (((val as u32) & 0x03) << 13usize);
        }
        ...
        #[doc = "ADC 0 external trigger injected conversion remapping"]
        #[must_use]
        #[inline(always)]
        pub const fn adc0_etrginj_remap(&self) -> bool {
            let val = (self.0 >> 17usize) & 0x01;
            val != 0
        }
        #[doc = "ADC 0 external trigger injected conversion remapping"]
        #[inline(always)]
        pub const fn set_adc0_etrginj_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
        #[doc = "ADC 0 external trigger regular conversion remapping"]
        #[must_use]
        #[inline(always)]
        pub const fn adc0_etrgreg_remap(&self) -> bool {
            let val = (self.0 >> 18usize) & 0x01;
            val != 0
        }
        #[doc = "ADC 0 external trigger regular conversion remapping"]
        #[inline(always)]
        pub const fn set_adc0_etrgreg_remap(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 18usize)) | (((val as u32) & 0x01) << 18usize);
        }
    ...
    impl core::fmt::Debug for Afiopcf0 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Afiopcf0")
                ...
                .field("adc0_etrginj_remap", &self.adc0_etrginj_remap())
                .field("adc0_etrgreg_remap", &self.adc0_etrgreg_remap())
    ...
    impl defmt::Format for Afiopcf0 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                ...
                self.adc0_etrginj_remap(),
                self.adc0_etrgreg_remap(),
    ...
    impl defmt::Format for Mapr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Mapr {{ spi1_remap: {=bool:?}, i2c1_remap: {=bool:?}, usart1_remap: {=bool:?}, usart2_remap: {=bool:?}, usart3_remap: {=u8:?}, tim1_remap: {=u8:?}, tim2_remap: {=u8:?}, tim3_remap: {=u8:?}, tim4_remap: {=bool:?}, can1_remap: {=u8:?}, swj_cfg: {:?}, spi3_remap: {=bool:?} }}",
                self.spi1_remap(),
                self.i2c1_remap(),
                self.usart1_remap(),
                self.usart2_remap(),
    ...
    impl core::fmt::Debug for Mapr2 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Mapr2").field("fsmc_nadv", &self.fsmc_nadv()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Mapr2 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Mapr2 {{ fsmc_nadv: {=bool:?} }}", self.fsmc_nadv())
        }
    }
}
pub mod vals {
