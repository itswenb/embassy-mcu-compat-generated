...
DMA1_CHANNEL4 = 60 , # [doc = "63 - CAN1_TX"]
...
mod _vectors { unsafe extern "C" { fn WWDGT () ; fn TAMPER () ; fn RTC () ; fn FMC () ; fn RCU_CTC () ; fn EXTI_LINE0 () ; fn EXTI_LINE1 () ; fn EXTI_LINE2 () ; fn EXTI_LINE3 () ; fn EXTI_LINE4 () ; fn DMA0_CHANNEL0 () ; fn DMA0_CHANNEL1 () ; fn DMA0_CHANNEL2 () ; fn DMA0_CHANNEL3 () ; fn DMA0_CHANNEL4 () ; fn DMA0_CHANNEL5 () ; fn DMA0_CHANNEL6 () ; fn ADC0_1 () ; fn CAN0_TX () ; fn CAN0_RX0 () ; fn CAN0_RX1 () ; fn CAN0_EWMC () ; fn EXTI_LINE9_5 () ; fn TIMER0_BRK_TIMER8 () ; fn TIMER0_UP_TIMER9 () ; fn TIMER0_TRG_CMT_TIMER10 () ; fn TIMER0_CC () ; fn TIMER2 () ; fn TIMER3 () ; fn I2C0_EV () ; fn I2C0_ER () ; fn I2C1_EV () ; fn I2C1_ER () ; fn SPI0 () ; fn SPI1 () ; fn USART0 () ; fn USART1 () ; fn USART2 () ; fn EXTI_LINE15_10 () ; fn RTC_ALARM () ; fn USBFS_WKUP () ; fn TIMER7_BRK_TIMER11 () ; fn TIMER7_UP_TIMER12 () ; fn TIMER7_TRG_CMT_TIMER13 () ; fn TIMER7_CC () ; fn ADC2 () ; fn EXMC () ; fn SDIO () ; fn SPI2 () ; fn UART3 () ; fn UART4 () ; fn TIMER5 () ; fn TIMER6 () ; fn DMA1_CHANNEL0 () ; fn DMA1_CHANNEL1 () ; fn DMA1_CHANNEL2 () ; fn DMA1_CHANNEL3 () ; fn DMA1_CHANNEL4 () ; fn CAN1_TX () ; fn CAN1_RX0 () ; fn CAN1_RX1 () ; fn CAN1_EWMC () ; fn USBFS () ; } pub union Vector { _handler : unsafe extern "C" fn () , _reserved : u32 , } # [unsafe(link_section = ".vector_table.interrupts")]
# [unsafe(no_mangle)]
pub static __INTERRUPTS : [Vector ; 68]
= [Vector { _handler : WWDGT } , Vector { _reserved : 0 } , Vector { _handler : TAMPER } , Vector { _handler : RTC } , Vector { _handler : FMC } , Vector { _handler : RCU_CTC } , Vector { _handler : EXTI_LINE0 } , Vector { _handler : EXTI_LINE1 } , Vector { _handler : EXTI_LINE2 } , Vector { _handler : EXTI_LINE3 } , Vector { _handler : EXTI_LINE4 } , Vector { _handler : DMA0_CHANNEL0 } , Vector { _handler : DMA0_CHANNEL1 } , Vector { _handler : DMA0_CHANNEL2 } , Vector { _handler : DMA0_CHANNEL3 } , Vector { _handler : DMA0_CHANNEL4 } , Vector { _handler : DMA0_CHANNEL5 } , Vector { _handler : DMA0_CHANNEL6 } , Vector { _handler : ADC0_1 } , Vector { _handler : CAN0_TX } , Vector { _handler : CAN0_RX0 } , Vector { _handler : CAN0_RX1 } , Vector { _handler : CAN0_EWMC } , Vector { _handler : EXTI_LINE9_5 } , Vector { _handler : TIMER0_BRK_TIMER8 } , Vector { _handler : TIMER0_UP_TIMER9 } , Vector { _handler : TIMER0_TRG_CMT_TIMER10 } , Vector { _handler : TIMER0_CC } , Vector { _reserved : 0 } , Vector { _handler : TIMER2 } , Vector { _handler : TIMER3 } , Vector { _handler : I2C0_EV } , Vector { _handler : I2C0_ER } , Vector { _handler : I2C1_EV } , Vector { _handler : I2C1_ER } , Vector { _handler : SPI0 } , Vector { _handler : SPI1 } , Vector { _handler : USART0 } , Vector { _handler : USART1 } , Vector { _handler : USART2 } , Vector { _handler : EXTI_LINE15_10 } , Vector { _handler : RTC_ALARM } , Vector { _handler : USBFS_WKUP } , Vector { _handler : TIMER7_BRK_TIMER11 } , Vector { _handler : TIMER7_UP_TIMER12 } , Vector { _handler : TIMER7_TRG_CMT_TIMER13 } , Vector { _handler : TIMER7_CC } , Vector { _handler : ADC2 } , Vector { _handler : EXMC } , Vector { _handler : SDIO } , Vector { _reserved : 0 } , Vector { _handler : SPI2 } , Vector { _handler : UART3 } , Vector { _handler : UART4 } , Vector { _handler : TIMER5 } , Vector { _handler : TIMER6 } , Vector { _handler : DMA1_CHANNEL0 } , Vector { _handler : DMA1_CHANNEL1 } , Vector { _handler : DMA1_CHANNEL2 } , Vector { _handler : DMA1_CHANNEL3 } , Vector { _handler : DMA1_CHANNEL4 } , Vector { _reserved : 0 } , Vector { _reserved : 0 } , Vector { _handler : CAN1_TX } , Vector { _handler : CAN1_RX0 } , Vector { _handler : CAN1_RX1 } , Vector { _handler : CAN1_EWMC } , Vector { _handler : USBFS } ,]
; } pub const TIMER2 : gdtimer22f7dd51f :: Timer2 = unsafe { gdtimer22f7dd51f :: Timer2 :: from_ptr (0x4000_0400usize as _) } ; pub const TIMER3 : gdtimer22f7dd51f :: Timer2 = unsafe { gdtimer22f7dd51f :: Timer2 :: from_ptr (0x4000_0800usize as _) } ; pub const TIMER5 : gdtimer54b5e73ec :: Timer5 = unsafe { gdtimer54b5e73ec :: Timer5 :: from_ptr (0x4000_1000usize as _) } ; pub const TIMER6 : gdtimer54b5e73ec :: Timer5 = unsafe { gdtimer54b5e73ec :: Timer5 :: from_ptr (0x4000_1400usize as _) } ; pub const TIMER11 : gdtimer895e47fd0 :: Timer8 = unsafe { gdtimer895e47fd0 :: Timer8 :: from_ptr (0x4000_1800usize as _) } ; pub const TIMER12 : gdtimer911ce6ab6 :: Timer9 = unsafe { gdtimer911ce6ab6 :: Timer9 :: from_ptr (0x4000_1c00usize as _) } ; pub const TIMER13 : gdtimer911ce6ab6 :: Timer9 = unsafe { gdtimer911ce6ab6 :: Timer9 :: from_ptr (0x4000_2000usize as _) } ; pub const RTC : gdrtc6b0c077c :: Rtc = unsafe { gdrtc6b0c077c :: Rtc :: from_ptr (0x4000_2800usize as _) } ; pub const WWDGT : gdwwdgt50884229 :: Wwdgt = unsafe { gdwwdgt50884229 :: Wwdgt :: from_ptr (0x4000_2c00usize as _) } ; pub const FWDGT : gdfwdgtdc3d0d7a :: Fwdgt = unsafe { gdfwdgtdc3d0d7a :: Fwdgt :: from_ptr (0x4000_3000usize as _) } ; pub const SPI1 : gdspi0946ced9d :: Spi0 = unsafe { gdspi0946ced9d :: Spi0 :: from_ptr (0x4000_3800usize as _) } ; pub const SPI2 : gdspi0946ced9d :: Spi0 = unsafe { gdspi0946ced9d :: Spi0 :: from_ptr (0x4000_3c00usize as _) } ; pub const USART1 : gdusart082eeb6ea :: Usart0 = unsafe { gdusart082eeb6ea :: Usart0 :: from_ptr (0x4000_4400usize as _) } ; pub const USART2 : gdusart082eeb6ea :: Usart0 = unsafe { gdusart082eeb6ea :: Usart0 :: from_ptr (0x4000_4800usize as _) } ; pub const UART3 : gduart3c678fe30 :: Uart3 = unsafe { gduart3c678fe30 :: Uart3 :: from_ptr (0x4000_4c00usize as _) } ; pub const UART4 : gduart3c678fe30 :: Uart3 = unsafe { gduart3c678fe30 :: Uart3 :: from_ptr (0x4000_5000usize as _) } ; pub const I2C0 : gdi2c01196dac6 :: I2c0 = unsafe { gdi2c01196dac6 :: I2c0 :: from_ptr (0x4000_5400usize as _) } ; pub const I2C1 : gdi2c01196dac6 :: I2c0 = unsafe { gdi2c01196dac6 :: I2c0 :: from_ptr (0x4000_5800usize as _) } ; pub const CAN0 : gdcan06b36baa3 :: Can0 = unsafe { gdcan06b36baa3 :: Can0 :: from_ptr (0x4000_6400usize as _) } ; pub const CAN1 : gdcan06b36baa3 :: Can0 = unsafe { gdcan06b36baa3 :: Can0 :: from_ptr (0x4000_6800usize as _) } ; pub const BKP : gdbkp16a620e0 :: Bkp = unsafe { gdbkp16a620e0 :: Bkp :: from_ptr (0x4000_6c00usize as _) } ; pub const PMU : gdpmu3bb0ce43 :: Pmu = unsafe { gdpmu3bb0ce43 :: Pmu :: from_ptr (0x4000_7000usize as _) } ; pub const DAC : gddac4f1e7381 :: Dac = unsafe { gddac4f1e7381 :: Dac :: from_ptr (0x4000_7400usize as _) } ; pub const CTC : gdctc0cad8643 :: Ctc = unsafe { gdctc0cad8643 :: Ctc :: from_ptr (0x4000_c800usize as _) } ; pub const AFIO : gdafiodd141c18 :: Afio = unsafe { gdafiodd141c18 :: Afio :: from_ptr (0x4001_0000usize as _) } ; pub const EXTI : gdexticadbcd9c :: Exti = unsafe { gdexticadbcd9c :: Exti :: from_ptr (0x4001_0400usize as _) } ; pub const GPIOA : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_0800usize as _) } ; pub const GPIOB : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_0c00usize as _) } ; pub const GPIOC : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_1000usize as _) } ; pub const GPIOD : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_1400usize as _) } ; pub const GPIOE : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_1800usize as _) } ; pub const GPIOF : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_1c00usize as _) } ; pub const GPIOG : gdgpioac3e5c224 :: Gpioa = unsafe { gdgpioac3e5c224 :: Gpioa :: from_ptr (0x4001_2000usize as _) } ; pub const ADC0 : gdadc01c84fb9d :: Adc0 = unsafe { gdadc01c84fb9d :: Adc0 :: from_ptr (0x4001_2400usize as _) } ; pub const ADC1 : gdadc1dbd8060f :: Adc1 = unsafe { gdadc1dbd8060f :: Adc1 :: from_ptr (0x4001_2800usize as _) } ; pub const TIMER0 : gdtimer0a0aa2af0 :: Timer0 = unsafe { gdtimer0a0aa2af0 :: Timer0 :: from_ptr (0x4001_2c00usize as _) } ; pub const SPI0 : gdspi0946ced9d :: Spi0 = unsafe { gdspi0946ced9d :: Spi0 :: from_ptr (0x4001_3000usize as _) } ; pub const TIMER7 : gdtimer0a0aa2af0 :: Timer0 = unsafe { gdtimer0a0aa2af0 :: Timer0 :: from_ptr (0x4001_3400usize as _) } ; pub const USART0 : gdusart082eeb6ea :: Usart0 = unsafe { gdusart082eeb6ea :: Usart0 :: from_ptr (0x4001_3800usize as _) } ; pub const ADC2 : gdadc1dbd8060f :: Adc1 = unsafe { gdadc1dbd8060f :: Adc1 :: from_ptr (0x4001_3c00usize as _) } ; pub const TIMER8 : gdtimer895e47fd0 :: Timer8 = unsafe { gdtimer895e47fd0 :: Timer8 :: from_ptr (0x4001_4c00usize as _) } ; pub const TIMER9 : gdtimer911ce6ab6 :: Timer9 = unsafe { gdtimer911ce6ab6 :: Timer9 :: from_ptr (0x4001_5000usize as _) } ; pub const TIMER10 : gdtimer911ce6ab6 :: Timer9 = unsafe { gdtimer911ce6ab6 :: Timer9 :: from_ptr (0x4001_5400usize as _) } ; pub const SDIO : gdsdio3e5180d0 :: Sdio = unsafe { gdsdio3e5180d0 :: Sdio :: from_ptr (0x4001_8000usize as _) } ; pub const DMA0 : gddma011392832 :: Dma0 = unsafe { gddma011392832 :: Dma0 :: from_ptr (0x4002_0000usize as _) } ; pub const DMA1 : gddma011392832 :: Dma0 = unsafe { gddma011392832 :: Dma0 :: from_ptr (0x4002_0400usize as _) } ; pub const RCU : gdrcuf8667f6f :: Rcu = unsafe { gdrcuf8667f6f :: Rcu :: from_ptr (0x4002_1000usize as _) } ; pub const FMC : gdfmc0cbd4130 :: Fmc = unsafe { gdfmc0cbd4130 :: Fmc :: from_ptr (0x4002_2000usize as _) } ; pub const CRC : gdcrc66a4f78d :: Crc = unsafe { gdcrc66a4f78d :: Crc :: from_ptr (0x4002_3000usize as _) } ; pub const USBFS_GLOBAL : gdusbfsglobal3505227a :: UsbfsGlobal = unsafe { gdusbfsglobal3505227a :: UsbfsGlobal :: from_ptr (0x5000_0000usize as _) } ; pub const USBFS_HOST : gdusbfshost5f42a79e :: UsbfsHost = unsafe { gdusbfshost5f42a79e :: UsbfsHost :: from_ptr (0x5000_0400usize as _) } ; pub const USBFS_DEVICE : gdusbfsdevicec5a1209d :: UsbfsDevice = unsafe { gdusbfsdevicec5a1209d :: UsbfsDevice :: from_ptr (0x5000_0800usize as _) } ; pub const USBFS_PWRCLK : gdusbfspwrclk2ac667f0 :: UsbfsPwrclk = unsafe { gdusbfspwrclk2ac667f0 :: UsbfsPwrclk :: from_ptr (0x5000_0e00usize as _) } ; pub const EXMC : gdexmc9f6a36f3 :: Exmc = unsafe { gdexmc9f6a36f3 :: Exmc :: from_ptr (0xa000_0000usize as _) } ; pub const DBG : gddbg7b62968c :: Dbg = unsafe { gddbg7b62968c :: Dbg :: from_ptr (0xe004_2000usize as _) } ; # [cfg (feature = "rt")]
pub use cortex_m_rt :: interrupt ; # [cfg (feature = "rt")]
pub use Interrupt as interrupt ;#[path="../../peripherals/gdadc01c84fb9d_v1.rs"] pub mod gdadc01c84fb9d;
#[path="../../peripherals/gdadc1dbd8060f_v1.rs"] pub mod gdadc1dbd8060f;
#[path="../../peripherals/gdafiodd141c18_v1.rs"] pub mod gdafiodd141c18;
...
#[path="../../peripherals/gddbg7b62968c_v1.rs"] pub mod gddbg7b62968c;
#[path="../../peripherals/gddma011392832_v1.rs"] pub mod gddma011392832;
#[path="../../peripherals/gdexmc9f6a36f3_v1.rs"] pub mod gdexmc9f6a36f3;
#[path="../../peripherals/gdexticadbcd9c_v1.rs"] pub mod gdexticadbcd9c;
#[path="../../peripherals/gdfmc0cbd4130_v1.rs"] pub mod gdfmc0cbd4130;
...
#[path="../../peripherals/gdi2c01196dac6_v1.rs"] pub mod gdi2c01196dac6;
#[path="../../peripherals/gdpmu3bb0ce43_v1.rs"] pub mod gdpmu3bb0ce43;
#[path="../../peripherals/gdrcuf8667f6f_v1.rs"] pub mod gdrcuf8667f6f;
...
#[path="../../peripherals/gdtimer22f7dd51f_v1.rs"] pub mod gdtimer22f7dd51f;
...
#[path="../../peripherals/gdusbfsdevicec5a1209d_v1.rs"] pub mod gdusbfsdevicec5a1209d;
#[path="../../peripherals/gdusbfsglobal3505227a_v1.rs"] pub mod gdusbfsglobal3505227a;
