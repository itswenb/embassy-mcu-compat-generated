...
PROVIDE(LVD_VAVD = DefaultHandler);
...
PROVIDE(RCU_CKFM = DefaultHandler);
PROVIDE(CMP_WAKEUP = DefaultHandler);
...
PROVIDE(PMU_VUVD_VOVD = DefaultHandler);
...
PROVIDE(TIMER0_BRK_CHANNEL = DefaultHandler);
PROVIDE(TIMER7_BRK_CHANNEL = DefaultHandler);
